...
public class FileReaderWriterUtil {
	 ...
	 * @param keyWord 查找包含某个关键字的信息：非null为带关键字查询；null为全文显示
	 * @return 当文件存在时，返回字符串；当文件不存在时，返回null
	 */
	public static String readFile(String filePath, String keyWord) {
	...
	public static boolean createNewFile(String filePath) {
		...
		// 先过滤掉文件名
		int index = filePathTurn.lastIndexOf(File.separator);
