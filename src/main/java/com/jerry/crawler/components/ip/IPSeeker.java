package com.jerry.crawler.components.ip;
import java.io.File;
...
public class IPSeeker {
	...
	private final static String BAD_IP_FILE = "IP地址库文件错误";
	private final static String UNKNOWN_COUNTRY = "未知国家";
	private final static String UNKNOWN_AREA = "未知地区";
